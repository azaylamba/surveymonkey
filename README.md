...
You have to design & build the backend for the application and the ability for the users to create and take surveys.
...
https://github.com/azaylamba/surveymonkey 
